...
public class DIVR extends Instrucao {
    ...
    public void executar(Memoria memoria, Registradores registradores) {
        int idRegistradorA = Integer.parseInt(memoria.getPosicaoMemoria(registradores.getValorPC())); // pegando o id do registrador A (parametro 1)
        registradores.incrementarPC(); // apos ler o parametro, incrementar o PC

        int idRegistradorB = Integer.parseInt(memoria.getPosicaoMemoria(registradores.getValorPC())); // pegando o id do registrador B (parametro 2)
        registradores.incrementarPC(); // apos ler o parametro, incrementar o PC
